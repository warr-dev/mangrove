...
table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_image_2 .v-src-width { width: auto !important; } #u_content_image_2 .v-src-max-width { max-width: 42% !important; } #u_content_button_1 .v-container-padding-padding { padding: 10px 10px 30px !important; } #u_content_button_1 .v-padding { padding: 13px 40px !important; } #u_content_heading_3 .v-font-size { font-size: 22px !important; } #u_content_text_7 .v-container-padding-padding { padding: 0px 120px 20px 15px !important; } }
    </style>
...
<body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #ffffff;color: #000000">
  <!--[if IE]><div class="ie-container"><![endif]-->
    <div>
        <p>Hi, WELCOME TO SILONAY MANGROVE RES :
            We are happy to informed you that your reservation was successfully confirmed</p>
...
<table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:14px 6px 12px;font-family:'Cabin',sans-serif;" align="left">
        
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      
      <img align="center" border="0" src="images/image-6.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 31%;max-width: 166.78px;" width="166.78" class="v-src-width v-src-max-width"/>
...
<table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h2 class="v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Cabin',sans-serif; font-size: 20px;">
    <div>Welcome to Silonay Mangrove <br />Reticence and Edowment System</div>
  </h2>
...
<table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #ffffff; line-height: 160%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 20px; line-height: 32px;"><strong>Your reservation is complete!</strong></span></p>
  </div>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="images/image-3.gif" alt="Check" title="Check" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 24%;max-width: 127.2px;" width="127.2" class="v-src-width v-src-max-width"/>
...
<table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #ffffff; line-height: 160%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 160%;">We are happy to informed you that your Reservation was successfully confirmed!</p>
  </div>
...
<table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #6e7172; line-height: 130%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 130%; text-align: left;"><span style="font-size: 20px; line-height: 26px;">Invoice to: </span></p>
<p style="font-size: 14px; line-height: 130%; text-align: left;"> </p>
<p style="font-size: 14px; line-height: 130%; text-align: left;"><span style="font-size: 16px; line-height: 20.8px;">Name:                            {{$reservation->getFullName()}}</span></p>
<p style="font-size: 14px; line-height: 130%; text-align: left;"><span style="font-size: 16px; line-height: 20.8px;">Address:                        {{$reservation->address}}</span></p>
<p style="font-size: 14px; line-height: 130%; text-align: left;"><span style="font-size: 16px; line-height: 20.8px;">Contact No.:                  {{$reservation->phone}}</span></p>
<p style="font-size: 14px; line-height: 130%; text-align: left;"><span style="font-size: 16px; line-height: 20.8px;">Date and Time:             {{$reservation->date_visit}}</span></p>
<p style="font-size: 14px; line-height: 130%; text-align: left;"><span style="font-size: 16px; line-height: 20.8px;">Payment method:      GCASH</span></p>
{{-- <p style="font-size: 14px; line-height: 130%; text-align: left;"><span style="font-size: 16px; line-height: 20.8px;">Amount:                         PHP </span></p>
<p style="font-size: 14px; line-height: 130%; text-align: left;"><span style="font-size: 16px; line-height: 20.8px;">Quantity:                        </span></p> --}}
<p style="font-size: 14px; line-height: 130%; text-align: left;"><span style="font-size: 16px; line-height: 20.8px;">Total:                                PHP {{$reservation->payment->total}}</span></p>
<p style="font-size: 14px; line-height: 130%; text-align: left;"><span style="font-size: 16px; line-height: 20.8px;">Gcash Reference:        {{$reservation->payment->reference_number}}</span></p>
{{-- <p style="font-size: 14px; line-height: 130%; text-align: left;"><span style="font-size: 16px; line-height: 20.8px;">Invoice No.:                   000002</span></p> --}}
<p style="font-size: 14px; line-height: 130%; text-align: left;"> </p>
  </div>
...
<table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #6e7172; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;">SILONAY MANGROVE RES</span></p>
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;">@2022</span></p>
  </div>
...
<div align="left">
  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Cabin',sans-serif;"><tr><td style="font-family:'Cabin',sans-serif;" align="left"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:43px; v-text-anchor:middle; width:180px;" arcsize="9.5%" stroke="f" fillcolor="#3AAEE0"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Cabin',sans-serif;"><![endif]-->
    <a href="" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #3AAEE0; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
      <span class="v-padding" style="display:block;padding:13px 50px;line-height:120%;"><p style="font-size: 14px; line-height: 120%;"><span style="font-size: 14px; line-height: 16.8px;">DOWNLOAD</span></p></span>
    </a>
...
<!--[if (mso)|(IE)]><td align="center" width="550" style="background-color: #f4faf2;width: 550px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
<div class="u-col u-col-100" style="max-width: 320px;min-width: 550px;display: table-cell;vertical-align: top;">
  <div style="background-color: #f4faf2;height: 100%;width: 100% !important;">
  <!--[if (!mso)&(!IE)]><!--><div style="height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"><!--<![endif]-->
...
<table id="u_content_text_7" style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #6e7172; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><em>Your payment has been received, kindly show the receipt and bring the requirements to be needed when you are entering the Silonay Mangrove Ecopark</em></span></p>
<p style="font-size: 14px; line-height: 140%;"> </p>
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><em>If you have any questions or concerns, please use your mobile phone to contact us.</em></span></p>
  </div>
...
<table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #d1e122; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;">w w w . silonaymangroveres . c o m</span></p>
  </div>
...
<p style="font-size: 14px; line-height: 180%;"><span style="font-size: 12px; line-height: 21.6px;">© 2022 RES. All Rights Reserved.</span></p>
  </div>
