...
<nav id="nav" class="fixed inset-x-0 top-2 flex flex-row justify-between z-10 text-white bg-transparent">
    ...
    <div class="p-4 hidden md:flex flex-row justify-between font-bold" style="height: fit-content">
        ...
        <a href="{{route('donation')}}" class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">Donation
            </a>
        @if (auth()->check())
            <a href="{{route('reservation')}}" class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">Reservation
            </a>
        @endif
...
<div id="nav-opened" class="fixed left-0 right-0 top-0 bg-white hidden mx-2 mt-16 rounded-br rounded-bl shadow z-10">
    <div class="p-2 divide-y divide-gray-600 flex flex-col">
        ...
        <a href="{{route('donation')}}" class="p-2 font-semibold hover:text-indigo-700">Donation</a>
        <a href="{{route('reservation')}}" class="p-2 font-semibold hover:text-indigo-700">Reservation</a>
