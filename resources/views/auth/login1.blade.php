            ...
            <div class="mycontent">
                ...
                <section class="text-gray-600 body-font ">
                    <div class="container xl:px-32 px-5 py-36 mx-auto flex flex-wrap items-center">
                        ...
                        <h3 class="title-font font-bold lg:text-7xl text-6xl text-white text-center md:text-left ">SILONAY MANGROVE RETICENCE AND ENDOWMENT SYSTEM WITH GEO TAGGING</h3>
