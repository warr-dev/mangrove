...
Route::middleware(['myauth:admin'])
    ...
    ->group(function(){
        ...
        Route::put('/user/{user}/active',['uses'=>'UserController@active','as'=>'user.active']);
        ...
        Route::get('/reservation/print/{type}/{start}/{end}',['uses'=>'HomepageController@printReservationReport','as'=>'reservation.print']);
